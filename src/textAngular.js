    ...
    function($compile, $timeout, taOptions, taSelection, taExecCommand, textAngularManager, $window, $document, $animate, $log, $q){
      return {
        ...
        link: function(scope, element, attrs, ngModel){
          ...
          if (attrs.taReadonly) {
            scope.displayElements.text.attr('ta-readonly', attrs.taReadonly);
            scope.displayElements.html.attr('ta-readonly', attrs.taReadonly);
          }
          if(attrs.taDisabled){
            scope.displayElements.text.attr('ta-disabled', 'disabled');
            scope.displayElements.html.attr('ta-disabled', 'disabled');
